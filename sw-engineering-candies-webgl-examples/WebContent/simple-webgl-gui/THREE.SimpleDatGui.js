...
THREE.SimpleDatGuiControl.__internals.prototype.createTextValue = function(value) {
    ...
    var _geometry = new THREE.ShapeGeometry($.GLOBAL_FONT.generateShapes(that.textHelper.truncated, $.FONT, $.DELTA_Z));
...
THREE.SimpleDatGuiControl.__internals.prototype.createLabel = function(name) {
    ...
    var _geometry = new THREE.ShapeGeometry($.GLOBAL_FONT.generateShapes(name, $.FONT, $.DELTA_Z));
...
THREE.SimpleDatGuiControl.__internals.prototype.createFrame = function() {
    ...
    var cubeGeometry2LineGeometry = function(input, material) {
        ...
        var line = new THREE.LineSegments(_geometry, material);
...
THREE.SimpleDatGuiControl.__internals.prototype.createComboBoxListFields = function(event) {
    ...
    for (var filedIndex = 0; filedIndex < that.comboBoxList.length; filedIndex++) {
        ...
        // Text
        var _geometry = new THREE.TextGeometry(text, $.FONT_PARAM);
...
THREE.SimpleDatGuiControl.__internals.prototype.createComboBoxText = function() {
    ...
    var _geometry = new THREE.TextGeometry(that.textHelper.truncated, $.FONT_PARAM);
...
THREE.SimpleDatGuiTextHelper.prototype.createFontShapes = function(value) {
    ...
    var shapes = this._options.GLOBAL_FONT.generateShapes(valueNew, this._options.FONT, this._options.DELTA_Z);
...
THREE.SimpleDatGuiTextHelper.prototype.calculateRightAlignText = function(value) {
    ...
    for (var i = fontshapesAll.length - 1; i > 1; i--) {
        var textGeometry1 = new THREE.ShapeGeometry(fontshapesAll[i - 1]);
        textGeometry1.computeBoundingBox();
        var boundingBox1 = textGeometry1.boundingBox;

        var textGeometry2 = new THREE.ShapeGeometry(fontshapesAll[i]);
        textGeometry2.computeBoundingBox();
        var boundingBox2 = textGeometry1.boundingBox;

        var charWidth = boundingBox2.max.x - boundingBox1.max.x;
        size -= charWidth;
        if (size < 30 &&
            !this.isTruncated) {
    ...
    if (fontshapesTruncated.length > 0) {
        ...
        var textGeometry = new THREE.ShapeGeometry(fontshapesTruncated[fontshapesTruncated.length - 1]);
    ...
    for (var i = 0; i < fontshapesTruncated.length; i++) {
        ...
        var textGeometry = new THREE.ShapeGeometry(fontshapesTruncated[i]);
        textGeometry.computeBoundingBox();
        var boundingBox = textGeometry.boundingBox;
...
THREE.SimpleDatGuiTextHelper.prototype.calculateLeftAlignText = function(value) {
    ...
    for (var i = 0; i < fontshapesAll.length - 1; i++) {
        ...
        var textGeometry = new THREE.ShapeGeometry(fontshapesAll[i]);
        textGeometry.computeBoundingBox();
        var boundingBox = textGeometry.boundingBox;
